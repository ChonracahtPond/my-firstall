                ...
                <div className="bg-white md:py-8 px-4 lg:max-w-7xl lg:mx-auto lg:px-8">
                    ...
                    <div className="inline-flex flex-col space-y-1 items-start justify-start h-full w-full">
                        <div className="inline-flex space-x-28 items-start justify-start pr-24 h-full w-full">
                            <p className="w-12 h-full text-sm font-medium text-gray-800 uppercase">อา.</p>
                            <p className="w-12 h-full text-sm font-medium text-gray-800 uppercase">จ.</p>
                            <p className="w-12 h-full text-sm font-medium text-gray-800 uppercase">อ.</p>
                            <p className="w-12 h-full text-sm font-medium text-gray-800 uppercase">พ.</p>
                            <p className="w-12 h-full text-sm font-medium text-gray-800 uppercase">พฤ.</p>
                            <p className="w-12 h-full text-sm font-medium text-gray-800 uppercase">ศ.</p>
                            <p className="w-12 h-full text-sm font-medium text-gray-800 uppercase">ส.</p>
                        </div>
                        <div className="flex flex-col items-start justify-start">
                            <div className="inline-flex items-center justify-start h-full w-full">
                                <div className="flex items-start justify-start w-40 h-full pl-2 pr-32 pt-2.5 pb-24 border border-gray-400">
